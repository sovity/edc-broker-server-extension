...
public class ContractOfferRecordUpdater {
    ...
    /**
     * Create new {@link DataOfferContractOfferRecord} from {@link FetchedContractOffer}.
     *
     * @param dataOffer            parent data offer db row
     * @param fetchedContractOffer fetched contract offer
     * @return new db row
     */
    public DataOfferContractOfferRecord newContractOffer(DataOfferRecord dataOffer, FetchedContractOffer fetchedContractOffer) {
    ...
    /**
     * Update existing {@link DataOfferContractOfferRecord} with changes from {@link FetchedContractOffer}.
     *
     * @param contractOffer        existing row
     * @param fetchedContractOffer changes to be integrated
     * @return if anything was changed
     */
    public boolean updateContractOffer(DataOfferContractOfferRecord contractOffer, FetchedContractOffer fetchedContractOffer) {
