...
insert into connector (endpoint, connector_id, created_at, last_refresh_attempt_at, last_successful_refresh_at,
                       online_status)
values ('https://my-connector.com/dsp', 'test-connector-1', '2019-01-01 00:00:00',
...
values ('https://my-connector.com/dsp',
        'test-asset-1',
        '{
